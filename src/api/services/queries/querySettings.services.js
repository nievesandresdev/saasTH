...
export const updateStaySettingsApi = (data) => apiHttp('POST', `${querySettingsPath}/${hosterPath}/updateStaySettings`, data)

export const getPostStaySettingsApi = () => apiHttp('GET', `${querySettingsPath}/${hosterPath}/getPostStaySettings`, [])
export const updatePostStaySettingsApi = (data) => apiHttp('POST', `${querySettingsPath}/${hosterPath}/updatePostStaySettings`, data)
