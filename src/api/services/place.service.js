...
export const getCategoriesByTypeApi = (params) => apiHttp('POST', `${placePath}/getCategoriesByType`, params, { showPreloader: false }, 'API_HELPER', false, true);
export const getTypePlacesApi = (params = {}) => apiHttp('GET', `${placePath}/getTypePlaces`, params, { showPreloader: false }, 'API_HELPER', false, true);
export const getAllApi = (data) => apiHttp('POST', `${saasPlacePath}/getPlacesSectionPlataform`, data, { showPreloader: false }, 'API_HELPER', false, true);
export const getDataUtilApi = (data) => apiHttp('POST', `${saasPlacePath}/getDataSectionPlataform`, data, { showPreloader: false }, 'API_HELPER', false, true);
