        ...
        <template #content>
            <div>
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm leading-[150%] htext-black-100">Ten en cuenta que si eliminas el subservicio deberás volver a crearlo para visualizarlo en la plataforma.</p>
                </div>
            </div>
