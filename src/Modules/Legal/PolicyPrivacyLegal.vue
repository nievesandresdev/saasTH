      ...
      <SectionConfig>
        <template v-slot:title>
            <div class="flex flex-col gap-2">
                ...
                <p class="font-normal text-sm">La política de privacidad explica de manera clara y sencilla cómo recopilamos y tratamos los datos personales de los huéspedes, cumpliendo con la legislación vigente. Además, informamos detalladamente sobre sus derechos en materia de protección de datos.</p>
                <div class="flex justify-end">
                    <div @click="openAndDownloadPolicy" class="flex cursor-pointer">
...
const openAndDownloadPolicy = () => {
    let filePath;

    if (policy_protection.value) {
        filePath = '/assets/policy/politica-delegado.pdf';
    } else {
        filePath = '/assets/policy/politica.pdf';
    }
    ...
    link.href = filePath;
    link.download = filePath.split('/').pop(); // Extraer el nombre del archivo de la ruta
