<template>
    <div class="h-screen px-6 bg-gray-50">
      ...
      <div class="grid grid-cols-4 gap-4 mt-4">
        ...
        <div class="bg-white border rounded-lg shadow flex items-center justify-center p-4 h-44">
        ...
        <div v-for="policy in policies" :key="policy.id" class="bg-white border rounded-lg shadow flex flex-col justify-between p-4 h-44">
          <div>
