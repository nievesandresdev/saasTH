<template>
    <div class="space-y-6">
        <div class="grid grid-cols-3 gap-4">
                ...
                >
                    <div v-if="hoverImg === index" class="hbg-black-100 opacity-25 w-full h-full absolute inset-0 rounded-xl">
                        <div  class="absolute space-x-4 position-center">
                            <button @click="openPreview(facilityStore.formatImage(image))">
                                <img class="w-5 h-5" alt="icon_search"  src="/assets/icons/1.TH.SEARCH.svg">
                            </button>
