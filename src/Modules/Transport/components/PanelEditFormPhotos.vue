                ...
                >
                    <div v-if="hoverImg === index" class="bg-black bg-opacity-25 w-full h-full absolute inset-0 rounded-xl p-2 flex justify-between">
                        <!-- <div  class="absolute space-x-4 position-center">
                            <button @click="openPreview(transportStore.formatImage(image))">
                        ...
                        <button
                            ...
                            @click="openPreview(transportStore.formatImage(image))"
                        >
                    ...
                    <img class="w-full h-full rounded-xl object-cover " :src="transportStore.formatImage(image)">
                </div>
        </div>
