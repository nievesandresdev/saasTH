    ...
    <div class="">
        ...
        >
            <template v-slot:button>
                <img class="w-6 h-6" src="/assets/icons/1.TH.Not response.svg" alt="">
            </template>
        ...
        <p class="absolute text-center text-xs leading-[90%] w-[130px] bottom-[-18px] left-[-45px]">No respondido</p>
    </div>
</template>
<script setup>
